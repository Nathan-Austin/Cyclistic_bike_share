...
```
We  can see that members mostly use the bikes for short commutes during the weekdays, where as causal users use the bikes for short trips more in the weekend.
